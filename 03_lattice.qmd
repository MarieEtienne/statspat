...
Ce cours est construit à partir du livre de @cressie2015statistics et de l'article @verhoef2018relationship
...
* Existence du modèle CAR  sous réserve que    $(I-C)^{-1} M$ est définie positive (@besag1974spatial) et alors
...
Dans @verhoef2018relationship, on trouve une caractérisation intéressante qui permet de faire le lien entre SAR et CAR
...
$$\P(Z_t,  Z_{t-1}, \ldots Z_1 \vert Z_0) = \prod_{s=1}^t Q_s(Z_s; Z_{s-1})$$ 
[Quel est l'intérêt d'une chaîne de Markov dans le traitement de la dépendance]{.rouge}
...
```{r}
load("/home/metienne/Cours/ENSAI/spatial/docs/Cours_liliane/documents-export-2024-06-19_reseau/LondonSuicide/LondonSuicides.RData")
london.gen <- st_read("/home/metienne/Cours/ENSAI/spatial/docs/Cours_liliane/documents-export-2024-06-19_reseau/LondonSuicide/LDNSuicides.shp")
