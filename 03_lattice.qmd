...
* Pour définir un champs de Markov, on définit des lois conditionnelles mais encore faut-il que la loi jointe existe !
...
où la somme est prise sur toutes les cliques $c$, $\Phi_c$ est un potentiel i.e une fonction définie sur une partie de $D$ et à valeurs dans $\R$ et $X_c =  \lvert X_s, s \in c \lVert$ et $Z$ est une constante de normalisation en général inconnue.
...
En pratique, on choisit la matrice $B$ du modèle SAR sous la forme
$B = \rho_s W$ et
