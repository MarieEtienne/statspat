...
* C'est une méthode alternative aux méthodes MCMC pour mener une inférence bayésienne. Premières idées dans @rue2009approximate, puis @lindgren2010explicit dans le cadre spatial et le lien avec les méthjodes de résolutions numériques.
...
Les observations sont indépendantes conditionnellement
aux variables latents et aux hyperparamètres $\theta_1$.
